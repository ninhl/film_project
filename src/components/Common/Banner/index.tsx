...
const Banner = (props: Props) => {
  ...
  return (
    ...
    >
      <Box className={styles.banner__wrapper}>
        ...
        <p className={styles.banner__desc}>
          Movies to motivate. Titles to thrill. Even entertainment to enlighten.
          Explore the movies and TV shows that unite an audience with your
          event’s purpose. Browse everything from the most talked about movies
          to timeless TV classics.
        </p>
